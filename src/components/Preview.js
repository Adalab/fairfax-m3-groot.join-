        ...
        <div>
          ...
          <section className="card__preview ">
            ...
            <ul className="social__links">
              ...
              <li>
                <a className="social__button linkedin" href={`https://www.linkedin.com/in/${this.props.linkedin}`} target="_blank" rel="noopener noreferrer">
                  <i className="fab fa-linkedin-in" />
                </a>
              </li>
              <li>
                <a className="social__button github" href={`https://www.github.com/${this.props.github}`} target="_blank" rel="noopener noreferrer">
